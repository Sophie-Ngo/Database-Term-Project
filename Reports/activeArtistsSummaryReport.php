...
<head>
  <meta charset="utf-8">
  <title>Active Artists Summary Report</title>
...
echo "<h2>Report of Active Artists</h2>";
...
$SQL = 
"SELECT Concat(firstname, ' ', lastname)                     AS 'Artist Name',
        Concat(street, ', ', city, ', ', state, ' ', Zips.zip) AS Address,
        telephonenumber                                      AS 'Phone',
        usualtype                                            AS 'Type',
        usualmedium                                          AS 'Medium',
        usualstyle                                           AS 'Style',
        saleslastyear                                        AS 'Sales Last Year',
        salesyeartodate                                      AS'Sales YTD'
FROM   Artist, Zips
WHERE  Artist.zip = Zips.zip";
